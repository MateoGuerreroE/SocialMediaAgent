...
const GENERATION_CONSTANTS = {
  ...
  AGENT_DECISION: `You are an orchestration agent that is proficient in deciding which agent should handle a given conversation. You will receive last messages to give you context, but attempt to give more importance to the latest ones. You have access to the following agents, each with their own use case and examples:`,
